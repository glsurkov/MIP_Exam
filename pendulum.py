...
import math
import numpy as np
import trapezoidVelocity as tp

IS_GUI = input('Показывать симуляцию или нет ? (Да/Нет): ')
OWN_REG = True
# physical params
dt = 1 / 240
q0 = 0
...
while t <= maxTime:
    ...
    #---------Trapezoidal_Motion_Profiles---------

    (curr_pos_d, curr_vel_d, curr_acc_d) = tp.trapezoidVelocity(q0_fact, pos_d, trajTime, t, 1.5/trajTime)
